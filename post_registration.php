...
if (empty($clean_data["appheader"]["datablock"]["registration"]["name"])) {$val--;}

if (filter_var($clean_data["appheader"]["datablock"]["registration"]["Email"], FILTER_VALIDATE_EMAIL)) {} else {$val--;}
if (empty($clean_data["appheader"]["datablock"]["registration"]["mobilenumber"])) {$val--;}
if (empty($clean_data["appheader"]["datablock"]["registration"]["dob"])) {$val--;}
if (empty($clean_data["appheader"]["datablock"]["registration"]["password"])) {$val--;}

if (empty($clean_data["appheader"]["datablock"]["registration"]["profileimage"])) {$val--;}
if (is_int ($clean_data["appheader"]["datablock"]["registration"]["distance"] )===true) {}else {$val--;}
if (is_int ($clean_data["appheader"]["datablock"]["registration"]["time"] )===true) {}else {$val--;}
if (empty($clean_data["appheader"]["datablock"]["registration"]["profileimage"])) {$val--;}
if (is_bool($clean_data["appheader"]["datablock"]["registration"]["terms"]) === true) {}else {$val--;}
if (is_bool($clean_data["appheader"]["datablock"]["registration"]["playstoreterms"]) === true) {}else {$val--;}
if (is_bool($clean_data["appheader"]["datablock"]["registration"]["locationpermission"]) === true) {}else {$val--;}
if (is_bool($clean_data["appheader"]["datablock"]["registration"]["memorypermission"]) === true) {}else {$val--;}
