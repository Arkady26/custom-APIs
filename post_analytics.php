...
function get_function_analytics($post_data) {
    // clean array
    ...
    $conn = conn();
    $field_array = $clean_data["appheader"]["datablock"]["analytics"];
    ...
    mysqli_close($conn);
    $function_output["from"] = "analytics";
...
switch ($view) {
    ...
    break;
    case "analytics":
        $function_output = get_function_analytics($post_data);
    break;
    case "":
        //404 - not found;//
        $function_output["status"] = 404;
