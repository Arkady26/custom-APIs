...
function get_function_setting($post_data) {
    // clean array
    ...
    $conn = conn();
    $field_array = $clean_data["appheader"]["datablock"]["setting"];
...
switch ($view) {
    ...
    break;
    case "setting":
        $function_output = get_function_setting($post_data);
    break;
    case "":
        //404 - not found;//
        $function_output["status"] = 404;
