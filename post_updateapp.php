...
function get_function_updateapp($post_data) {
    // clean array
    ...
    $conn = conn();
    //INSERT//
    $field_array = $clean_data["appheader"]["datablock"]["updateapp"];
    ...
    mysqli_close($conn);
    $function_output["from"] = "updateapp";
...
switch ($view) {
    ...
    break;
    case "updateapp":
        $function_output = get_function_updateapp($post_data);
    break;
    case "":
        //404 - not found;//
        $function_output["status"] = 404;
