...
if (mysqli_connect_errno()) {leave("database_connection_fail");}
...
$timenow=date("U");
if (($timenow-$clean_data["appheader"]["transmissiondatetime"])>3600){return false;}
...
if ($clean_data["appheader"]["key"]=="newlatcherinstallation"){return $clean_data;}
...
if ($clean_data["privatekeypair"]===false){return false;}
...
//check for valid json chars //
	...
	$check=check_blockhash($block,$hash);
...
if ($clean_data==false){return false;}
